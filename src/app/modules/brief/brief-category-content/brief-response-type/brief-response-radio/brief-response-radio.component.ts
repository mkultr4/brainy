...
@Component({
  selector: '[app-brief-response-radio]',
  templateUrl: './brief-response-radio.component.html',
  styleUrls: ['./brief-response-radio.component.scss']
})
export class BriefResponseRadioComponent implements OnInit {
  ...
  addOption() {
    ...
    var newOption = <Option>{ id: uuid(), label: `Opción ${lengthOpt}`, type: 'radio', icon: undefined, order: lengthOpt };
